...
export default function OrderPendingPaymentPage({
  ...
  return (
    <main className="container-padding mx-auto max-w-xl py-8">
      ...
      <div className="mt-6 rounded-2xl border border-amber-300/40 bg-card p-5">
      ...
      <div className="mt-4 grid gap-3">
        <a href={searchParams.wa ?? 'https://wa.me/254700000001'} target="_blank" className="btn-primary w-full text-center">WhatsApp Us</a>
